...
```
k8s-certificate-questions-handson/
...
2. **Debug Menu** (hidden by default) — All k8s-certificate-questions-handson framework links (7 stages, agent files, tools). Only shown when the user clicks the **debug button** at the **bottom-right corner** of the page.
...
**Goal:** Create a template project that can be used by other projects at start — `k8s-certificate-questions-handson` v0.9
