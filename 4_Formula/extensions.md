...
* 🔐 Azure Key Vault Setup: [setup_azure.md](file:///C:/projects/k8s-certificate-questions-handson/2_Environment/setup_azure.md)
* 🛸 Fly.io Deployment Setup: [fly_io.md](file:///C:/projects/k8s-certificate-questions-handson/2_Environment/fly_io.md)
* 🧠 Local AI Stack (Ollama + Qdrant): [setup_ai.md](file:///C:/projects/k8s-certificate-questions-handson/2_Environment/setup_ai.md)
* 📐 Architecture & Diagrams: [architecture.md](file:///C:/projects/k8s-certificate-questions-handson/2_Environment/architecture.md)
