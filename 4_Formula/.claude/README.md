...
This folder documents everything that must be moved or configured in the **root `.claude/` folder** when a new project is initialized from `k8s-certificate-questions-handson`.
