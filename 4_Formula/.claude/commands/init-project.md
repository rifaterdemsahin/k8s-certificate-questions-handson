...
Sets up a new project from `k8s-certificate-questions-handson` by:
...
7. Making the first commit: `chore: initialize project from k8s-certificate-questions-handson`
...
```
git add .
git commit -m "chore: initialize <project-name> from k8s-certificate-questions-handson"
